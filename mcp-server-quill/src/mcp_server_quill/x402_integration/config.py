...
from mcp_server_quill.x402_integration.accepted_assets import (
    CHAIN_ID_TO_NETWORK,
    EVM_NETWORKS,
    SOLANA_NETWORKS,
...
class X402Config(BaseSettings):
    ...
    Environment variables:
        MCP_QUILL_X402_PRICING_MODE: Enable/disable payment enforcement ("on" or "off")
        MCP_QUILL_X402_FACILITATOR_URLS: JSON array of facilitator URLs (e.g., '["https://url1","https://url2"]')
        MCP_QUILL_X402_PAYEE_EVM_ADDRESS: EVM wallet address for receiving payments
        MCP_QUILL_X402_PAYEE_SOLANA_ADDRESS: Solana wallet address for receiving payments
        MCP_QUILL_X402_PRICING_CONFIG_PATH: Path to tool_pricing.yaml file
    """
    ...
    def facilitator_config(self) -> list[FacilitatorConfig]:
        ...
        if self.facilitator_urls:
            ...
            logger.warning(
                ...
                "Set MCP_QUILL_X402_FACILITATOR_URLS environment variable."
            )
