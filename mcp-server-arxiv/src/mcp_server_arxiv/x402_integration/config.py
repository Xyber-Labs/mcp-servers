...
from mcp_server_arxiv.x402_integration.accepted_assets import (
    CHAIN_ID_TO_NETWORK,
    EVM_NETWORKS,
    SOLANA_NETWORKS,
    ...
    def validate_config(self) -> None:
        ...
        if self.chain_id not in valid_chains:
            ...
            raise ValueError(
                ...
                f"Add it to CHAIN_ID_TO_NETWORK in x402_integration/accepted_assets.py if this is a new network."
            )
        ...
        if network in EVM_NETWORKS:
            ...
            if not is_recognized:
                raise ValueError(
                    ...
                    f"Add this token to NETWORK_CONFIGS in your x402_integration/accepted_assets.py if you "
...
class X402Config(BaseSettings):
    ...
    Environment variables:
        MCP_ARXIV_X402_PRICING_MODE: Enable/disable payment enforcement ("on" or "off")
        MCP_ARXIV_X402_FACILITATOR_URLS: JSON array of facilitator URLs (e.g., '["https://url1","https://url2"]')
        MCP_ARXIV_X402_PAYEE_EVM_ADDRESS: EVM wallet address for receiving payments
        MCP_ARXIV_X402_PAYEE_SOLANA_ADDRESS: Solana wallet address for receiving payments
        MCP_ARXIV_X402_PRICING_CONFIG_PATH: Path to tool_pricing.yaml file
    """
    ...
    # EVM wallet address (0x...) - used for Base, Avalanche, SKALE Base, BNB Chain, Polygon, Sei
    ...
    def facilitator_config(self) -> list[FacilitatorConfig]:
        ...
        if self.facilitator_urls:
            ...
            logger.warning(
                ...
                "Set MCP_ARXIV_X402_FACILITATOR_URLS environment variable."
            )
